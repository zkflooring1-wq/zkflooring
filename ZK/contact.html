                    ...
                    <div class="col-lg-5">
                        <div class="contact-content-wrap">
                            ...
                            <div class="title-wrap" data-wow-duration="1.5s" data-wow-delay=".4s">
                                ...
                                <h2 class="sec-title">Get in Touch with Inotek Contact Information</h2>
                                <p>We’re always ready to helps your business. Let’s talk with us</p>
                            </div>
        ...
        <div class="tv-contact-map">
            <div class="container-fluid p-0">
                <div class="row">
                    <!--Map-->
                    <div class="map-box">
                            <iframe class="map-canvas" src="https://maps.google.com/maps?q=London%20Eye%2C%20London%2C%20United%20Kingdom&t=m&z=10&output=embed&iwloc=near" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="tv-branch-section space bg-light">
            <div class="container">
                ...
                <div class="title-wrap three text-center" data-wow-duration="1.5s" data-wow-delay=".4s">
                    ...
                    <h2 class="sec-title">Visit another branch Office</h2>
                    <p>Collaboratively supply bricks-and-clicks metrics for maintainable users empowered best <br> reinvent unique value for just in time consult practices</p>
                </div>
                <div class="row gy-30">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="branch-single-box">
                            <div class="image-box">
                                <div class="image">
                                    <img src="assets/images/resource/branch01.webp" alt="San Fransisco Head Quarters">
                                </div>
                            </div>
                            <div class="branch-content">
                                <div class="branch-header">
                                    <h4 class="location-name">San Fransisco</h4>
                                    <p class="location-type">HEAD QUARTERS</p>
                                </div>
                                <div class="divider"></div>
                                <p class="address">1600/2 New elephant Rd, Sandigo - USA</p>
                                <div class="phone"><a href="tel:+8801234567890">+880 123 (4567) 890</a></div>
                                <div class="email"><a href="mailto:support.example@gmail.com">support.example@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="branch-single-box">
                            <div class="image-box">
                                <div class="image">
                                    <img src="assets/images/resource/branch02.webp" alt="Salt Lake City">
                                </div>
                            </div>
                            <div class="branch-content">
                                <div class="branch-header">
                                    <h4 class="location-name">Salt Lake City</h4>
                                    <p class="location-type">BRANCH OFFICE</p>
                                </div>
                                <div class="divider"></div>
                                <p class="address">1600/2 New elephant Rd, Sandigo - USA</p>
                                <div class="phone"><a href="tel:+8801234567890">+880 123 (4567) 890</a></div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="branch-single-box">
                            <div class="image-box">
                                <div class="image">
                                    <img src="assets/images/resource/branch03.webp" alt="Los Angeles">
                                </div>
                            </div>
                            <div class="branch-content">
                                <div class="branch-header">
