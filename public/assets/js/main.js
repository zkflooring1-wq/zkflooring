...
(function ($) {
	...
	if (document.readyState === "complete" || document.readyState === "interactive") {
		// Document is already loaded or interactive, initialize immediately
	...
	function mobileMenu() {
		if ($(".mobile-menu").length) {
			// In Next.js, menus are already rendered in React to avoid hydration mismatch and duplicate menus.
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		const thumb1 = document.querySelector('.thumb[data-thumb="1"]');
		if (thumb1) {
